-- 108_add_virtual_portfolio_snapshot_run_type.sql
-- -------------------------------------------------------------------
-- Adds the one new run_type value the daily virtual-portfolio
-- snapshot job needs (109_snapshot_virtual_portfolios.py) -- same
-- pattern as every earlier run_type addition in this project
-- (16_/26_/33_/84_/106_).
--
-- HOW TO RUN THIS:
